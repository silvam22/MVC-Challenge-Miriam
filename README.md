...
## Description
This is a Tech Blog site where users can read, post, and delete posts as well as comment. It uses Handlebars.js as the templating language, Sequelize as the ORM, and the express-session npm package for authentication.
